...
import { TypeMetadataWMS } from '@/api/config/types/layer-schema-types';
import { TypeMapMouseInfo } from '@/geo/map/map-viewer';
export declare const layerTypes: Record<"CSV" | "WKB" | "ESRI_DYNAMIC" | "ESRI_FEATURE" | "ESRI_IMAGE" | "IMAGE_STATIC" | "GEOJSON" | "XYZ_TILES" | "VECTOR_TILES" | "OGC_FEATURE" | "WFS" | "WMS", import("@/api/config/types/layer-schema-types").TypeGeoviewLayerType>;
